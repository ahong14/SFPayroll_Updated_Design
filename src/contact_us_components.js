var {SubmitButton} = require('./careers_components');
    ...
    render(){
        return(
            <div class = "follow_us_container" id = {this.props.siteId}>
                ...
                <a href = {this.props.src} target = "_blank" ><img className = "follow_image" src = {this.props.imagesrc}/>
                </a>
            </div>
        )
    }
...
class ContactUs extends React.Component{
    render(){
        <div id = "contact_info">
                ...
                <FollowContainer siteId = {facebook.siteId} site = {facebook.siteName} src = {facebook.source} imagesrc = {facebook.image}/>
