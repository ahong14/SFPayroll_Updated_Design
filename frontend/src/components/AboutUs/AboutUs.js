        ...
        return(
            <div className="container-fluid" id="about_us_header">
                ...
                <div className="about_section align_center" id="bylaws_section">
                    ...
                    <div>
                        <p className="text-center font-italic"> Click here for details: <a href="http://www.sfpayroll.org/boardfiles/2014_Bylaws_Constitution.pdf" rel="noopener noreferrer" target="_blank"> By Laws </a> </p>
                    </div>
                </div>
                <AboutSections/>
                <Members/>
