...
import cpc from '../../photos/cpc_2023_logo.png';
    ...
    return (
        <div className="container-fluid" id="welcomeContainer">
            ...
            <div className="welcome_awards_join">
                <h3 className="text-center" id="welcome_text">
                    Welcome to the San Francisco Bay Area Chapter of the
                ...
                >
                    <a
                        ...
                        target="_blank"
                    >
                        <img className="logoImage" src={apa} alt="APA Logo" />
                    </a>
                    <a
                    ...
                    <a
                        ...
                        target="_blank"
                    >
                        <img className="logoImage" src={cpc} alt="cpc logo" />
                    </a>
                </Grid>
