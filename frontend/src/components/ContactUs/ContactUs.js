        ...
        <div className="container-fluid" id="contact_us_container">
            ...
            <div className="align_center" id="contact_info">
                <p>
                    General Information
                    <a
                        href="emailto:sfbac.apa@gmail.com"
                ...
                <p>
                    Reservation:
                    <a
                        href="mailto:RSVP@sfpayroll.org"
                        rel="noopener noreferrer"
                        target="_blank"
                    >
                        RSVP@sfpayroll.org
                ...
                <p>
                    Job Posting:
                    <a
                        href="mailto:sfbac.apa@gmail.com"
                        rel="noopener noreferrer"
                        target="_blank"
                    >
                        sfbac.apa@gmail.com
                ...
                <p>
                    Webmaster
                    <a
                        href="mailto:alexhong681@gmail.com"
                        rel="noopener noreferrer"
                        target="_blank"
                    >
                        alexhong681@gmail.com
                    </a>
                </p>
            </div>
            ...
            <div class="follow_us_container">
                <a
                    href="https://www.linkedin.com/in/sfbac-apa-74bb7421/"
                    rel="noopener noreferrer"
                    target="_blank"
                >
            ...
            <div class="follow_us_container">
                <a
                    href="https://twitter.com/SFBAC_APA"
                    rel="noopener noreferrer"
                    target="_blank"
                >
            ...
            <div class="follow_us_container">
                <a
                    href="https://www.facebook.com/payrollpeeps/"
                    rel="noopener noreferrer"
                    target="_blank"
                >
