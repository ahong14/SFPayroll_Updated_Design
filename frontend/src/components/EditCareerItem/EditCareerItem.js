        ...
        return(
            <div className="card border-info">
                <div className="card-body">
                    <a href={this.props.link} target="_blank" rel="noopener noreferrer"> <h5 className="card-title text-center"> {this.props.title} </h5> </a> 
                            ...
                            <div className="modal-body">
                                {this.state.deleteClicked != true ? 
                                    <form>
                                        ...
                                        <div className="form-check">
                                            <input name="link" className="form-check-input" onChange={this.enableNewPdf} placeholder="Yes" type="checkbox"/>
                                ...
                                {this.state.newPdf == true ? 
                                    <form>
                                        ...
                                        <input disabled={this.state.disableForms} name="position" type="text" className="form-control" id="position" onChange={this.handleNewPdfContent}/>
                                        
                                        <label htmlFor="city" className="font-weight-bold"> City: </label>
                                        <input disabled={this.state.disableForms} name="city" type="text" className="form-control" id="city" onChange={this.handleNewPdfContent}/>
                                        
                                        <label htmlFor="state" className="font-weight-bold"> State: </label>
                                        <input disabled={this.state.disableForms} name="state" type="text" className="form-control" id="state" onChange={this.handleNewPdfContent}/>
                                        
                                        <label htmlFor="position" className="font-weight-bold"> Select Position:</label>
                                        <select className="form-control" id="payroll_position" name="select" onChange={this.handleNewPdfContent}>
                                        ...
                                        <textarea disabled={this.state.disableForms} name="description" onChange={this.handleNewPdfContent} className="form-control" rows="5" id="job_description"></textarea>
