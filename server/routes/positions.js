...
router.put('/edit', (req, res) => {
    ...
    if(req.body.params){
        ...
        newCareerContent = {...req.body.params.newCareerContent};
        newPdf = req.body.params.newPdf;
    }

    else if(req.body){
        id = req.body.id;
        newCareerContent = {...req.body.newCareerContent};
        newPdf = req.body.newPdf;
    }

    console.log(newCareerContent);
        ...
        pdfHeaders.forEach(header => {
            switch(header){
                ...
                case 'Title':
                    ...
                    break;
                case 'Position':
                    currentPdfText = header + ": " + newCareerContent.payrollPosition;
                    doc.text(currentPdfText);
                    doc.moveDown(2);
                    break;
